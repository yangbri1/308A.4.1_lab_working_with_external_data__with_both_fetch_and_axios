// // To use:
// // (1) Comment out every line of code in "index.js"
// // (2) Conversely, select every line in "index_axios.js" (ctrl + a),
// // (3) Un-comment (ctrl + /).
// // ########################################################################
// // # Lab 308A.4.1: Working with External Data ("Javascript Axios Lab" -- Convert Fetch to Axios)
// // # Brian Yang
// // # Submit CodeSandbox Link to Canvas (dependencies not working w/ VSCode)
// // ########################################################################

// // importing all modules from Carousel.js file under "Carousel"
// import * as Carousel from "./Carousel.js";
// // importing axios effects from "axios" library -- allows usage of axios.<method> to initiate any request i.e. GET
// import axios from "axios";
// // import axios package using require function (another way)
...
// // set up default headers for HTTP GET request
// axios.defaults.headers.get["x-api-key"] = API_KEY;

// // require async function to utilize await
...
//   // Note: axios do NOT do data manipulation...as informed in lecture
...
//   // retrieving HTTP request using axios w/ GET method,
//   // headers could be included but already declared at the very top so no need here
...
//   // axios automatically serializes response body to json format
//   // unlike fetch() function, no need to call .json() method
...
// // change up above fetch() functions to axios & set an axios default header
